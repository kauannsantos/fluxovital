...
if (!isset($_SESSION['id_instituicao'])) {
    header("/fluxovital/page/cadastro/instituicao/categorias/editar_funcionario.php");
    exit;
}

$id = $_GET['id'] ?? null;

if (!$id || $id != $_SESSION['id_instituicao']) {
    // segurança: só pode editar se for sua instituição
    header("Location: painel_instituicao.php?error=nao_autorizado");
    exit;
}
...
<body>
  <div class="container">
    ...
    <form action="atualizar_instituicao.php" method="post">
      ...
      <a href="painel_instituicao.php" class="btn btn-secondary ms-2">Cancelar</a>
    </form>
  </div>
</body>
</html>
