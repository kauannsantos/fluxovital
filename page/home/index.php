...
<head>
  ...
  <style>
    ...
    .navbar {
      background-color: #9d040e; /* Cor de fundo da barra de navegação (vermelho escuro) */
    }
    ...
    .btn-danger:hover {
      background-color: #9d040e; /* Cor no hover do botão */
    }
    ...
    footer, .custom-footer {
      background-color: #9d040e; /* Cor de fundo do rodapé */
      color: white;
      padding: 15px;
      text-align: center;
      font-size: 0.9rem;
        ...
        <ul class="navbar-nav ms-auto align-items-lg-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDoacoes">
              <li><a class="dropdown-item" href="/fluxovital/page/cadastro/escolha_categoria.php">Doação de Sangue</a></li>
              <li><a class="dropdown-item" href="/fluxovital/page/cadastro/escolha_categoria.php">Doação de Médula Óssea</a></li>
              <li><a class="dropdown-item" href="/fluxovital/page/cadastro/escolha_categoria.php">Doação de Leite Materno</a></li>
            </ul>
          </li>

          <!-- Link para campanhas -->
          <li class="nav-item"><a class="nav-link" href="/fluxovital/page/home/categoria/campanhas.php">Campanhas</a></li>

          <!-- Link para relatórios -->
          <li class="nav-item"><a class="nav-link" href="/fluxovital/page/home/categoria/relatorio.php">Relatórios</a></li>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 shadow-sm">
            <div class="card-body d-flex flex-column align-items-center text-center">
              ...
              <a href="/fluxovital/page/home/categoria/campanhas.php" class="btn btn-danger mt-auto">Acessar</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 shadow-sm">
            <div class="card-body d-flex flex-column align-items-center text-center">
              ...
              <a href="/fluxovital/page/home/categoria/relatorio.php" class="btn btn-danger mt-auto">Acessar</a>
            </div>
          </div>
        </div>
