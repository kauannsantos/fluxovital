  ...
  <main class="container">
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-12 col-md-6 col-lg-4">
        <a href="/fluxovital/page/cadastro/doador.php" class="card-option" aria-label="Opção para cadastro como doador">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <a href="/fluxovital/page/cadastro/instituicao.php" class="card-option" aria-label="Opção para cadastro como instituição">
