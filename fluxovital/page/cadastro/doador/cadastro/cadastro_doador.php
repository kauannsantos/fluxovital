...
<main class="form-wrapper">
  <div class="form-card">
    ...
    <p class="text-center text-muted">
      Após este cadastro, você será direcionado a um pequeno questionário sobre seu tipo de doação.<br>
      <strong>Deseja doar mais de um tipo?</strong> Basta se cadastrar novamente escolhendo outra opção.
    </p>

    <form method="POST" action="processa_doador.php" onsubmit="return validarFormulario()" novalidate>

      <div class="mb-3">
        <label for="tipo_doador" class="form-label">Tipo de doação</label>
        <select name="tipo_doador" id="tipo_doador" class="form-select" required>
          <option value="" disabled selected>Selecione...</option>
          <option value="sangue">Sangue</option>
          <option value="medula">Medula Óssea</option>
          <option value="leite">Leite Materno</option>
        </select>
      </div>
